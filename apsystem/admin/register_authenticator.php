                ...
                <form action="#" method="post">
                    <div class="row">
                        <div class="text-center mx-auto">
                            <p>A verification email has been sent to the administrator. Please request the verification code from the administrator.</p>
                            <input type="text" placeholder="6 Digit Code">
                        </div>
                        <div class="mt-3 text-center">
                            <input class="bttn bg-color border text-white" type="submit" value="Submit">
                        </div>
                    </div>
                </form>
            </div>
