...
<body class="bg-white">
    ...
    <div class="container ">
        <div class="row mt">
            ...
            <div class="col-md-7">
                <div class="login-box d-flex justify-content-center align-items-center border border-dark">
                    ...
                    <div class="login-box-body">
                        ...
                        <form action="login.php" method="POST">
                            ...
                            <div class="text-center">
                                <button id="modalregis" type="button" class="btn color-button"><a href="../admin/register.php" class="text-white">Create New Account</a></button>
                            </div>
                        </form>
                    </div>
