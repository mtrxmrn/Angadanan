    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_edit.php">
          ...
          <div class="form-group">
            <label for="contact" class="col-sm-3 control-label">Civil Status</label>

            <div class="col-sm-9">
              <select class="form-control" name="civil_status" id="edit_civil_status" required>
                <option value="" selected>- Select -</option>
                <option value="Married">Married</option>
                <option value="Single">Single</option>
                <option value="Widowed">Widowed</option>
          ...
          <div class="form-group">
            <label for="edit_religion" class="col-sm-3 control-label">Religion</label>
          ...
          <div class="form-group">
            <label for="edit_citizenship" class="col-sm-3 control-label">Citizenship</label>

            <div class="col-sm-9">
              <input type="text" class="form-control" id="edit_citizenship" name="citizenship">
            </div>
          </div>
